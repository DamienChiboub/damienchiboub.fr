...
<meta name="keywords" content="damienchiboub.fr sport de damien chiboub chiboub damien chiboubdamien fnac facebook linkedin viadeo">
<meta name="date" content="<?php include '_vars.php'; echo $metaup;?>">
<meta name="robots" content="index, follow, archive">
<title>Projets sportifs de Damien Chiboub | damienchiboub.fr</title>
<meta name="description" content="Projets sportifs de Damien Chiboub, A l'etude - damienchiboub.fr ">
...
<li class="active"><a href="http://www.damienchiboub.fr/sport">Sport</a></li>
...
<ul class="span2 nav nav-tabs nav-stacked">
              <li><a class="accordion-toggle" data-toggle="collapse" href="#Sport">Sport<i class="icon-chevron-right pull-right"></i></a></li>
            </ul>
        </ul>

<div class="span5">
<div class="hero-unit">
<p class="text"><h1>Sport</h1></p><br></div>
...
<a class="accordion-toggle" data-toggle="collapse" href="#Sport">
Projets Sportifs
</a>
</div>
<div id="Sport" class="accordion-body collapse">
...
<div class="tab-content">
                <div class="tab-pane active" id="1">
                  <p class="lead">
<a href="#Projet-Sport" onclick="window.open('https://plus.google.com/photos/110705607218372468993/albums/5816682073558026433/5816684147452125954', 'Projet-Sport', 'scrollbars=yes,width=640,height=500,left=480')"><img src="img/projet-sport-damien-chiboub.jpg"></a>
                 </p>
                </div>
