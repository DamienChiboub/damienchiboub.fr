...
<meta name="keywords" content="damienchiboub.fr damien chiboub site web chiboub damien chiboubdamien fnac facebook linkedin viadeo">
<meta name="date" content="<?php include '_vars.php'; echo $metaup;?>">
<meta name="robots" content="index, follow, archive">
<title>Bienvenue sur le site de Damien Chiboub | damienchiboub.fr</title>
<meta name="description" content="Site personnel d'information d&eacute;velopp&eacute; par Damien Chiboub - damienchiboub.fr 
Vous trouverez des informations sur Damien Chiboub, son parcours, sa vie, ses int&eacute;r&ecirc;ts">
...
<div class="alert alert-info">
  ...
  <strong>Github </strong> : Code source disponible sur <a href="https://github.com/" target="_blank">Github</a> @ <a href="https://github.com/DamienChiboub/damienchiboub.fr" target="_blank">DamienChiboub/damienchiboub.fr</a>
</div>
...
<li class="active"><a href="http://www.damienchiboub.fr"><i class="icon-home"></i></a></li>
...
<h1><p class="text-info">Damien Chiboub</p></h1>
<p class="lead"><?php include '_vars.php'; echo $a;?><br>
<?php echo $work;?></p>
</div>
...
<a class="accordion-toggle" data-toggle="collapse" href="#Flux">
@Damien_Chiboub
</a>
</div>
<div id="Flux" class="accordion-body in collapse" style="height: auto; ">
...
<div class="tab-content">
                ...
                <a class="twitter-timeline" href="https://twitter.com/Damien_Chiboub" data-widget-id="306054393130795008"><img src="img/loading.gif"></a>
                <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
                </div>
                <div class="tab-pane" id="noid">
                 <p class="lead">
