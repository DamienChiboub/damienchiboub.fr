...
<meta name="keywords" content="damienchiboub.fr lifestyle de damien chiboub chiboub damien chiboubdamien fnac facebook linkedin viadeo">
<meta name="date" content="<?php include '_vars.php'; echo $metaup;?>">
<meta name="robots" content="index, follow, archive">
<title>Lifestyle de Damien Chiboub | damienchiboub.fr</title>
<meta name="description" content="Lifestyle de Damien Chiboub, Plaisir, Conso, Autre - damienchiboub.fr">
...
<li class="active"><a href="http://www.damienchiboub.fr/lifestyle">Lifestyle</a></li>
...
<ul class="span2 nav nav-tabs nav-stacked">
              <li><a class="accordion-toggle" data-toggle="collapse" href="#Plaisir">Plaisir<i class="icon-chevron-right pull-right"></i></a></li>
              <li><a class="accordion-toggle" data-toggle="collapse" href="#Conso">Conso <i class="icon-chevron-right pull-right"></i></a></li>
...
<div class="span5">
<div class="hero-unit">
<p class="text-info"><h1>Lifestyle</h1></p><br></div>
...
<a class="accordion-toggle" data-toggle="collapse" href="#Plaisir">
Plaisir
</a>
</div>
<div id="Plaisir" class="accordion-body collapse">
<div class="accordion-inner">

<div class="tabbable">
              <ul class="nav nav-tabs">
   <li class="active"><a href="#Hiver" data-toggle="tab">Hiver</a></li>
   <li><a href="#Contribute" data-toggle="tab">Contribution</a></li>
	</ul>

<div class="tab-content">
                <div class="tab-pane active" id="Hiver">
                  <p class="lead"><a href="#Damien-Chiboub" onclick="window.open('https://lh6.googleusercontent.com/-qKJAxNNgvSo/UR0X93v1hDI/AAAAAAAAAyA/j9CVfjUJy6E/s712/vlcsnap-2013-02-13-18h59m50s163.png', 'Damien-Chiboub', 'scrollbars=yes,width=640,height=500,left=480')"><img src="img/section-lifestyle_damien-chiboub.jpg"></a>
                 </p>
                </div>

                <div class="tab-pane" id="Contribute">
                 <p class="lead"><center>
<blockquote class="twitter-tweet" lang="fr"><p>En 2013 <a href="https://twitter.com/search/%23reverse">#reverse</a>-engineering.fr va revenir dans une nouvelle version,Attention ‡ ceux qui ne #patch#corrigent pas les #vulns#failles#leaks!</p>&mdash; Damien Chiboub (@Damien_Chiboub) <a href="https://twitter.com/Damien_Chiboub/status/287255490457640960">4 janvier 2013</a></blockquote>
...
<div class="accordion-group">
<div class="accordion-heading">
<a class="accordion-toggle" data-toggle="collapse" href="#Conso">
Conso
</a>
</div>

<div id="Conso" class="accordion-body collapse">
<div class="accordion-inner">
<div class="tabbable">
              <ul class="nav nav-tabs">
   <li class="active"><a href="#Cuisine" data-toggle="tab">Cuisine</a></li>
...
<div class="tab-content">
                <div class="tab-pane active" id="Cuisine">
                  <p class="lead">
<a href="#Cuisine" onclick="window.open('http://pinterest.com/damienchiboub/cooking/', 'Cuisine', 'scrollbars=yes,width=640,height=500,left=480')"><img src="img/section-lifestyle_damien-chiboub-cooking.jpg"></a>
                 </p>
                </div>
                <div class="tab-pane" id="Burger">
                 <p class="lead">
<a href="#Cuisine" onclick="window.open('https://plus.google.com/photos/110705607218372468993/albums/5829002208541353793', 'Cooking', 'scrollbars=yes,width=640,height=500,left=480')"><img src="img/section-lifestyle_damien-chiboub-burger.jpg"></a>
...
<div class="accordion-inner">
<img src="img/section-lifestyle_Damienchiboub.png">
</div>
</div>
</div>
</div>
