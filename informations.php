...
<meta name="keywords" content="damienchiboub.fr informations sur damien chiboub chiboub damien chiboubdamien fnac facebook linkedin viadeo">
<meta name="date" content="<?php include '_vars.php'; echo $metaup;?>">
<meta name="robots" content="index, follow, archive">
<title>Informations sur Damien Chiboub | damienchiboub.fr</title>
<meta name="description" content="Informations sur Damien Chiboub, Histoire, Competences, Skills, Interets - damienchiboub.fr">
...
<li class="active"><a href="http://www.damienchiboub.fr/informations">Informations</a></li>
...
<ul class="span2 nav nav-tabs nav-stacked">
              <li><a class="accordion-toggle" data-toggle="collapse" href="#Histoire">Histoire<i class="icon-chevron-right pull-right"></i></a></li>
              <li><a class="accordion-toggle" data-toggle="collapse" href="#Skills">Skills <i class="icon-chevron-right pull-right"></i></a></li>
              <li><a class="accordion-toggle" data-toggle="collapse" href="#Interets">Int&eacute;r&ecirc;ts <i class="icon-chevron-right pull-right"></i></a></li>
            </ul>

<div class="span5">
<div class="hero-unit">
<h1>Infor</h1><p class="text">mations</p></div>
...
<a class="accordion-toggle" data-toggle="collapse" href="#Histoire">
Histoire
</a>
</div>
<div id="Histoire" class="accordion-body collapse">
<div class="accordion-inner">
<p class="lead">
J&rsquo;ai grandi dans un monde sans ogm dans un coin cool du 78<br>
il y avait une salle <a href="#" onClick="window.open('http://www.club-micropuce.fr', 'Club_micropuce', 'scrollbars=yes,width=640,height=480,left=480')">informatique</a> proche du coll&egrave;ge, que j&rsquo;ai d&eacute;couvert assez  jeune<br>
Mes premiers pas, c&rsquo;est sur <a href="#" onClick="window.open('http://en.wikipedia.org/wiki/Atari_ST', 'Atari_ST', 'scrollbars=yes,width=640,height=480,left=480')">Atari ST</a><br>
puis j&rsquo;ai d&eacute;couvert <a href="#" onClick="window.open('http://support.microsoft.com/kb/83245/fr', 'Windows3point1', 'scrollbars=yes,width=640,height=480,left=480')">Windows 3.1</a><br>
Mon premier jeu, bien avant les Quake 3<br>
Unreal et Counter Strike, fut <a href="#" onClick="window.open('http://en.wikipedia.org/wiki/Castle_of_the_Winds', 'Castle_of_the_winds', 'scrollbars=yes,width=640,height=480,left=480')">Castle of the Winds</a><br>


J&rsquo;ai &eacute;t&eacute; &agrave; New York vers 15 ans, puis au Canada l&rsquo;ann&eacute;e suivante.<br>
...
<div class="accordion-group">
<div class="accordion-heading">
<a class="accordion-toggle" data-toggle="collapse" href="#Skills">
Skills
</a>
</div>

<div id="Skills" class="accordion-body collapse">
<div class="accordion-inner">
<p class="lead">
...
<div class="tabbable">
   ...
   <li class="active"><a href="#Audit" data-toggle="tab">Audit</a></li>
    ...
    <li><a href="#Developpement" data-toggle="tab">Developpement</a></li>
    <li><a href="#Exploitation" data-toggle="tab">Exploitation</a></li>
    <li><a href="#Securite" data-toggle="tab">S&eacute;curit&eacute;</a></li>
    <li><a href="#Ressources" data-toggle="tab">Ressources</a></li>
    <li><a href="#Veille" data-toggle="tab">Veille</a></li>              
</ul>
                ...
                Audit des syst&egrave;mes d&rsquo;informations<br>
                 </p>
                </div>
                <div class="tab-pane" id="Administration">
                 <p class="lead">Windows, unix, mac<br>
                 Interconnections, routage<br>
                 Serveurs, applicatifs intranet/web<br>
                </p>
               </div>
                <div class="tab-pane" id="Analyse">
                <p class="lead">Logs, donn&eacute;es<br>
                  Algorithmes, retro-conception</p>
                 <br>
                </div>
                <div class="tab-pane" id="Developpement">
                <p class="lead">
                php xhtml sql<br>
                 windev c/cpp perl bash scripting<br>
                <pre>Apprentissage : Symfony, Orm, Twig, Bootstrap, Poo </pre>
                 </p>
                </div>
                <div class="tab-pane" id="Exploitation">
                <p class="lead">
                Migration, d&eacute;ploiement <br>
                Utilisateurs, Gestion de projets<br>
                Parc Informatique, r&eacute;seau, brassage
                </p>
                </div>
              ...
              <p class="lead">                 
                ...
                <div class="tab-pane" id="Ressources">
                 <p class="lead">
                 Depuis 4 ans sur Mac<br>
                 j&rsquo;ai pr&eacute;c&eacute;demment travaill&eacute; sur Windows et Unix
                 <pre>Syst&egrave;mes
                <pre>Mac : Virtual Box, Open Office, Wireshark, Nmap, Terminal, Scripting, Perl, Xcode, Gdb</pre>
                <pre>Windows : Vmware/virtual PC, Suite Office, mstsc/vnc/pc anywhere, Dos, Scripting, Sysinternalstools</pre>
                <pre>Unix/Linux : Rhel, Debian, Gentoo, Fedora, Ubuntu, kde/gnome/xfce, lilo/grub, Filesystems, Git/Svn</pre>
                </pre>
                <pre>Conception
                <pre>Developpement : Algorithmes, xhtml, php, sql, mod&eacute;lisation, twig, boostrap, symfony 2</pre>
                </pre>
                </p>
                </div>
                <div class="tab-pane" id="Veille">
                 <p class="lead">Participe &agrave; de nombreux &eacute;v&egrave;nements IT</p>
...
<div class="accordion-group">
<div class="accordion-heading">
<a class="accordion-toggle" data-toggle="collapse" href="#Interets">
Int&eacute;r&ecirc;ts
</a>
</div>
<div id="Interets" class="accordion-body collapse">
<div class="accordion-inner">
<p class="lead">
